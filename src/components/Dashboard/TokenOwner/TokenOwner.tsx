...
const innerstyles = require('./token-owner.css');
const styles = require('../dashboard.css');

class TokenOwner extends React.Component<any, any> {
                ...
                <div className={innerstyles.content}>
                    <div className={styles.titleSection}>
                        <div className={styles.firstTitle}>
                            ...
                            <span className={styles.firstTitleItem}>User Role : Token Owner</span>
                        </div>
