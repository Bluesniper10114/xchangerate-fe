...
import { setupDetails, getMarketMakerOffers, getMarketMakerSetupDetails, updateMarketMakerSetupData } from '../actions';
...
class MarketMakerForm extends  React.Component<any, any> {
    ...
    onSubmit(values: object) {
        ...
        this.props.updateMarketMakerSetupData(updatedData);
        this.props.setupDetails(data);
        this.props.getMarketMakerOffers();
