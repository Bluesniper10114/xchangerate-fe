...
import { setupDetails, getExchangesOffers, getExchangesSetupDetails } from 'Components/SetupDetails/actions';
...
class ExchangesForm extends  React.Component<any, any> {
  ...
  componentWillMount() {
    const { setup_details, getExchangesSetupDetails } = this.props;
