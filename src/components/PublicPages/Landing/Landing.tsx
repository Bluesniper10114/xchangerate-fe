...
import ExchangePoolModal from 'Components/PublicPages/ExchangePoolModal';
    ...
    render() {
        ...
        const Hearder = (
            <header className={styles.header}>
                ...
                <ul className={styles.menu}>
                    ...
                    <li><Link to="/" onClick={this.openXRRTokenModal.bind(this)}>Buy XRR Tokens</Link></li>
                </ul>
        ...
        return (
            <div className={styles.landingPage}>
                ...
                {/* <ShareModal isOpen={this.state.isShareModalOpen} onConfirm={this.openLoginModal.bind(this)} onCancel={this.onCancelShare.bind(this)} width="900"/> */}
                {/* <AutobotModal isOpen={true} onCancel={this.onCancelShare.bind(this)} width="1100"/> */}
                {/* <ExchangePoolModal isOpen={true} onCancel={this.onCancelShare.bind(this)} width="1100"/> */}
                {/*<ShareModal isOpen={true} onConfirm={this.openLoginModal.bind(this)} onCancel={this.onCancelShare.bind(this)} width="900"/>*/}
                    ...
                    <div className={styles.firstSectionContent}>
                        ...
                        <div className={styles.whitePaperWrapper}>
                            ...
                            <div className={styles.whitePaperDesc}>
                                ...
                                <span className={styles.whitePaperDescText}>Influencing The Influencer lorem ipsum lorem ipsum</span>
                                <Button className={styles.whitePaperDescButton + " medium green"} onClick={() => history.push('/login')}>Download</Button>
                            </div>
                        </div>
                    </div>
                </div>
